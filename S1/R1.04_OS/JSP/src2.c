...
/**
 * \struct moisD1annee
 * \brief structure d'un mois dans une annee
 * 
*/
typedef struct {
    char nom; /** nom du mois de lannee*/
    int nbJours; /**le nombre de jours d'un mois*/
}moisD1annee; /**Structure des mois d'une annee*/

/**
 * \struct nomDonneeDansUneAnnee
 * \brief structure des noms donnee dans une annee
 * 
*/
typedef struct {
...
}nomDonneeDansUneAnnee; /**Structure des noms donnees dans une annee*/
 ...
 */
int main() {
    char lettre; /**declaration d'une lettre*/
    bool contientVal; /**booleen pour tester la presence d'une valeur*/
    mot8lettres mot; /**declaration d'un mot*/
    init(mot);
    saisir(mot);
    afficher(mot);
