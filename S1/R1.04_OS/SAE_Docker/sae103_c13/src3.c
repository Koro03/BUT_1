...
*
* @brief programme propose de jouer à un jeu de sudoku à partir d'un fichier .sud
...
/**
 * \struct faire_beau
 * \brief structure qui sert à faire jolie
*/
typedef struct {
...
typedef struct {
    char nom[8]; /** Nom de l'étudiant·e */
    char bah_non; /** Lettre indiquant son groupe td */
    int mais_non; /** variable qui fait pas beau*/
} str_non; /** Structure d'un·e étudiant·e */
...
int main(){
    tGrille grille;
    int numLigne,numColonne,valeur,compt; /**numero de ligne, de colonne, valeur et compteur*/
