/**
*
* @brief : programme permet de jouer au jeu de sudoku  et en même temps de savoir cb de fois un nom à été donnée dans une année
*
*/
 ...
 * \details cette fonction permet de saissir un chiffre puis la compare pour verifier qu'elle est valide
 * 
 * @param S 
 */
void saisir(int *S){
